(function (window) {
    ...
    opspark.preload = function (game) {
        ...
        game.load.image('steve', './asset/collectable/N.png');
        game.load.image('grace', './asset/collectable/X.png');
        game.load.image('kennedi', './asset/collectable/Man.png');
        game.load.image('max', './asset/collectable/A.png');
